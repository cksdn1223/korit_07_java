...
/*
    ...
    AND(&&) : 곱 연산자 -> 하나라도 false 면 false
    OR(||) : 합 연산자 -> 하나라도 true 면 true
    NOT(!) : true 값을 false로, false 값을 true 로 역전시키는 연산자
*/
public class Operator02 {
    public static void main(String[] args) {
        ...
        System.out.println("TXT="+result1);
        boolean result2 = flag1 && flag2;
        System.out.println("TXF="+result2);
        boolean result3 = flag2 && flag2;
        System.out.println("FXF="+result3);
        System.out.println("----- || 연산자 -----");
