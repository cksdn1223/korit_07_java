...
//        Arrays.stream(centralControl.getDeviceArray()).filter(power -> power!=null).forEach(power -> power.on());
//        for (Power power : centralControl.getDeviceArray()) {
//            if(power != null) power.off();
//        }
//        for (Power power : centralControl.getDeviceArray()) {
//            if(power != null) power.on();
//        }
