...
public class Main {
    public static void main(String[] args) {
        System.out.println("안녕하세요, 제이름은 안근수입니다.");
//        System.out.println(안녕하세요); // 오류 발생
        ...
        /*
            ...
            그렇다면 권장되는 방식은 ?
                데이터를 '변수'에 대입하고, 변수를 통해서 명령을 내리는 방식
        ...
        /*
            Java 에서의 변수 명명 규칙 :
                1. 카멜 표기법(camel case) 사용
                    ...
                    두 번재 단어의 첫 번재 문자만 대문자
                    ex) 한 단어 짜리 : result
                    ex) 복수 단어 : myTestResult
                2. 특수문자 지양

                cf) python 변수 표기 방식은 스네이크(snake case) 라고 해서 my_test_result 와 같은 방식으로 작성
        */
        ...
        /*
            ...
            '문자'와 '문자열'은 서로 다른 개념인데, 문자(하나짜리)를 세 번 더했을 경우에는
            더이상 문자가 아니라 문자열로 인식되기 때문에 원하는 방식으로 출력되지 않습니다.

            그렇기 때문에 ( System.out.println("" + name1 + name2 + name3); //결과값 : 안근수 )
            에서 sout() 의 () 내부에 "" 를 넣어주니까, 원하는 결과값을 얻을 수 있었습니다.

            즉, 작은 따옴표('')는 '문자'를 표시하기 위한 기호
            큰따옴표("")는 "문자열"을 표시하기 위한 기호
            (근데 python이랑 JavaScript 에서는 또 이런 구분이 없습니다)
        ...
        */
        ...
        System.out.println(123+"1");        // 결과값 : 1231   근데 얘가 예외적
        ...
        Integer width5 = 500;
        Integer width6 = 600;
        System.out.println(width5+width6);      // 대문자로 시작하는 Integer
...
//        int pi = 3.14;    // 오류 발생
        ...
        */
        ...
        System.out.println("원의 반지름이 43인 원의 둘레 : " + 2*pi*43);
        System.out.println("원의 반지름이 43인 원의 넓이 : " + pi*(43*43));
        ...
        /*
            ...
            제 전공은 ~ 이며, mbti는 ~ 입니다. 열심히 할게요 !!!'
            와 같이 출력될 수 있도록 sout 을 작성하시오
        */
        //초기화
        name10 = "김찬우";
        major10 = "정보전자시스템공학과";
