...
//        System.out.println("이름 : " + name);
        /*
            이상의 코드에서 문제점은 데이터를 입력받지 않고 그대로 넘어감
            왜 이런 문제가 생기냐면 nextInt() 에서 값을 입력하고 저희가 enter 를 치게 되는데,
            그 경우 다음 nextLine() 에서는 enter 키를 받아들여서 빈값인 상태로 enter 를 쳤다고
            인지하게 되기 때문에 곧장 출력문으로 넘어갔기 때문입니다.
