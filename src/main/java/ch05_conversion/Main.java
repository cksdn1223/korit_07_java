...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("변형 : " + (int)cast2);       // a를 int로 형변환 시 97

        // 업캐스팅 방법 # 2
        // 새로운 변수를 선언하여 캐스팅이 이루어진 데이터를 집어넣는 방법
        char cast3 = 'b';
        int casted3 = cast3;
        // 변수를 선언할 때의 자료형이 변환되기를 원하는 자료형으로 명시해줍니다.
        System.out.println("원형: " + cast3);
        System.out.println("변형: " + casted3);

        System.out.println("===============================");
        // 다운캐스팅 : 용량이 더 적은 자료형으로 변환하는 것을 의미
        int cast4 = 99;     // 얘는 # 1 으로,
        int cast5 = 100;    // 얘는 # 2로

        // 지시 사향 : 다운캐스팅하는 방법을 업캐스팅 방법 # 1, 2를 참조하여 char 형으로 바꾼 후
